...
export const skills: SkillsProps = {
  ...
  Frontend: ["HTML", "CSS", "Bootstrap", "Material UI","JQuery","React.js","Next.js", "Angular", "Redux","React Flows"," Jest", "React Testing Library","Enzyme","Formik", "Yup","Styled Components"],
